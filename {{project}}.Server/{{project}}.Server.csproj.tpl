...
<Project ToolsVersion="15.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <ItemGroup>
    ...
    <Reference Include="NFive.SDK.Core.net, Version=0.1.0.22, Culture=neutral, processorArchitecture=MSIL">
      <HintPath>..\packages\NFive.SDK.Core.0.1.0.22\lib\net452\NFive.SDK.Core.net.dll</HintPath>
      <Private>False</Private>
    </Reference>
    <Reference Include="NFive.SDK.Server.net, Version=0.1.0.18, Culture=neutral, processorArchitecture=MSIL">
      <HintPath>..\packages\NFive.SDK.Server.0.1.0.18\lib\net452\NFive.SDK.Server.net.dll</HintPath>
      <Private>False</Private>
    </Reference>
